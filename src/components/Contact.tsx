...
const socialLinks = [
  ...
  {
    name: 'Instagram',
    url: 'https://www.instagram.com/alegria.churrasco',
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    color: 'bg-[#E4405F] hover:bg-[#D92D4C]'
  }
]

export default function Contact() {
  return (
    <section id="contato" className="section-spacing bg-gradient-to-b from-white to-churrasco-50/30 relative overflow-hidden">
      <div className="max-w-7xl mx-auto container-padding">
        ...
        >
          <h2 className="heading-primary mb-6">Fale Conosco</h2>
          <p className="text-xl text-churrasco-700 max-w-2xl mx-auto">
            Entre em contato e leve o melhor do churrasco para sua festa!
          </p>
        </motion.div>
      ...
      {/* Decorative Elements */}
      <div className="absolute -bottom-16 -right-16 w-32 h-32 bg-churrasco-500/10 rounded-full blur-3xl"></div>
      <div className="absolute -top-16 -left-16 w-32 h-32 bg-churrasco-500/10 rounded-full blur-3xl"></div>
    </section>
  )
} 